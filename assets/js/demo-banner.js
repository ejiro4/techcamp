  ...
  $('#fileupload').fileupload({
   ...
   // xhrFields: {rid:localStorage.rid},   
	...
	disableImageResize: /Android(?!.*Chrome)|Opera/.test(
	  ...
	  url: 'https://crowdvote.quantumcloud.ng/api/imagesBannerEdit/?email='+localStorage.email+'&uid='+localStorage.uid+'&dir='+localStorage.dir,
...
jQuery('#fileupload') // Replace with your form id
    .bind('fileuploaddone', function (e, data) {
		...
		//alert("ok");
		location.href= 'vote-banner.html';
