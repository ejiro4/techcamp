...
$(function () {
  $('[data-toggle="tooltip"]').tooltip()
	 ...
	 // theme setting
	 $(".switcher-icon, .switcher-icon-search").on("click", function(e) {
        e.preventDefault();
	 ...
	 // theme setting
	 $(".switcher-icon-2, .switcher-icon-search").on("click", function(e) {
        e.preventDefault();
        $(".right-sidebar-2").toggleClass("right-toggled");
	...
	// theme setting
	 $(".switcher-icon-3, .switcher-icon-search").on("click", function(e) {
        e.preventDefault();
        $(".right-sidebar-3").toggleClass("right-toggled");
